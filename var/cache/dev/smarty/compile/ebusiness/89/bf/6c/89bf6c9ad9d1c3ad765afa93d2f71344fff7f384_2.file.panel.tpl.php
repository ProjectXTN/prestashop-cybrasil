...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  ...
  'file_dependency' => 
  array (
    '89bf6c9ad9d1c3ad765afa93d2f71344fff7f384' => 
    array (
      0 => '/var/www/html/themes/ebusiness/modules/ybc_themeconfig/views/templates/hook/panel.tpl',
      1 => 1743673724,
      2 => 'file',
    ),
  ),
...
" class="ybc-theme-panel-loading-logo" src="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['tc_modules_dir']->value, ENT_QUOTES, 'UTF-8');?>
img/loading.gif" /> 
                    <br/>
...
?>
                                <li style="background: <?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['skin']->value['main_color'], ENT_QUOTES, 'UTF-8');?>
;" <?php if ($_smarty_tpl->tpl_vars['configs']->value['YBC_TC_SKIN'] == $_smarty_tpl->tpl_vars['skin']->value['id_option']) {?>class="active"<?php }?> data-val="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['skin']->value['id_option'], ENT_QUOTES, 'UTF-8');?>
" title="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['skin']->value['name'], ENT_QUOTES, 'UTF-8');?>
"><?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['skin']->value['name'], ENT_QUOTES, 'UTF-8');?>
</li>
                            <?php
}
...
?>
                                    <li <?php if ($_smarty_tpl->tpl_vars['configs']->value['YBC_TC_LAYOUT'] == $_smarty_tpl->tpl_vars['layout']->value['id_option']) {?>class="active"<?php }?> data-val="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['layout']->value['id_option'], ENT_QUOTES, 'UTF-8');?>
...
?>
                                    <li><span rel='<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['bg']->value, ENT_QUOTES, 'UTF-8');?>
' class="ybc-theme-panel-bg<?php if ($_smarty_tpl->tpl_vars['configs']->value['YBC_TC_BG_IMG'] == $_smarty_tpl->tpl_vars['bg']->value) {?> active<?php }?>" style="background: url('<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['moduleDirl']->value, ENT_QUOTES, 'UTF-8');?>
bgs/<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['bg']->value, ENT_QUOTES, 'UTF-8');?>
.png');"></span></li>
                                <?php
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
...
<div class="tc_comparison_msg tc_comparison_success">
    ...
    <a href="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['tc_comparison_link']->value, ENT_QUOTES, 'UTF-8');?>
...
<?php echo '<script'; ?>
 type="text/javascript">
    var YBC_TC_FLOAT_CSS3 = <?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['YBC_TC_FLOAT_CSS3']->value, ENT_QUOTES, 'UTF-8');?>
;
    var YBC_TC_AJAX_URL = '<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['moduleDirl']->value, ENT_QUOTES, 'UTF-8');?>
ajax.php';
<?php echo '</script'; ?>
><?php }
}
